...
export function AssessmentViewScreen() {
  ...
  return (
    <div className="w-full px-4 sm:px-6 lg:px-8 py-8 space-y-6 animate-fadeIn font-sans select-none">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5">
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-1 text-xs font-mono text-slate-500 dark:text-slate-400">
                ...
                <span className="text-slate-700">·</span>
                <span>Berth Assigned: <strong className="text-emerald-400">{selectedBerth || "B-01"}</strong></span>
              </div>
            </div>
          </div>

          {/* Large Score Display Box */}
          <div className="p-5 rounded-xl bg-slate-950/80 border border-slate-800 text-center shrink-0 min-w-[180px]">
            ...
            <div className="mt-2 inline-flex items-center gap-1.5 px-3 py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-[11px] font-mono font-bold uppercase">
      ...
      <div className="rounded-2xl bg-slate-900/90 border border-slate-800 p-6 space-y-4 shadow-sm text-xs">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="p-4 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-slate-700 transition-all space-y-2.5">
          ...
          <div className="p-4 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-slate-700 transition-all space-y-2.5">
            ...
            <div className="flex justify-between text-[10px] font-mono text-slate-400 pt-0.5">
              ...
              <span className="text-emerald-400 font-semibold">Zero Grounding Risk</span>
            </div>
          </div>
          ...
          <div className="p-4 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-slate-700 transition-all space-y-2.5">
            ...
            <div className="flex justify-between text-[10px] font-mono text-slate-400 pt-0.5">
              ...
              <span className="text-slate-300 font-semibold">50 Units Discharged</span>
            </div>
          </div>
          ...
          <div className="p-4 rounded-xl bg-slate-950/70 border border-slate-800 hover:border-slate-700 transition-all space-y-2.5">
            ...
            <div className="flex justify-between text-[10px] font-mono text-slate-400 pt-0.5">
              ...
              <span className="text-slate-300 font-semibold">71+ Moves/Hour Target</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="p-5 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-3 shadow-sm">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-[11px] text-slate-400 pt-1 border-t border-slate-800/60">
              ...
              <span className="text-cyan-400 font-bold">B-01 Deepwater</span>
            </div>
          </div>
        </div>
        ...
        <div className="p-5 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-3 shadow-sm">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-cyan-400 font-bold">42 min</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-slate-300 font-sans">Productivity</span>
              <span className="text-amber-400 font-bold">71 moves/hour</span>
            </div>
          </div>
        </div>
      ...
      {/* STATUS Card */}
      <div className="p-5 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-3 text-xs shadow-sm font-mono">
        <div className="flex items-center justify-between border-b border-slate-800 pb-2">
          <h3 className="font-bold uppercase tracking-wider text-slate-400">
            STATUS
          </h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div className="flex items-center gap-2 text-emerald-400 font-bold p-2.5 rounded-xl bg-slate-950/70 border border-slate-800">
      ...
      <div className="rounded-2xl bg-slate-900/90 border border-slate-800 p-6 space-y-3 shadow-sm">
        <div className="flex items-center justify-between border-b border-slate-800 pb-3">
          <div className="flex items-center gap-2">
